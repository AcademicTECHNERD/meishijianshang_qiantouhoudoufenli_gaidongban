<template>
  <el-breadcrumb class="app-breadcrumb" separator=">"
    style="height:32px;backgroundColor:rgba(65, 81, 100, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:;borderWidth:2px;borderStyle:;borderColor:rgba(65, 81, 100, 1);">
