    ...
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role == item.roleName" class="menulist-item"
        ...
        <!-- <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;"
          background-color="#2A3542" text-color="#AEB2B7" active-text-color="#F8675E" default-active="0">
  ...
  <el-menu-item v-for="(child, sort) in menu.child" :key="sort" :index="(index + 2) + '-' + sort"
    @click="menuHandler(child.tableName)">{{ child.menu }}</el-menu-item>
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;"
          ...
          <el-menu-item index="home" :style="menulistBorderBottom" @click="menuHandler('')">
            <i class="el-icon-s-home" />首页
          </el-menu-item>

          <el-submenu index="personalCenter" :style="menulistBorderBottom">
            <template slot="title">
          ...
          <el-submenu v-for="(menu, index) in item.backMenu" :key="menu.menu" :index="'menu-' + index"
            :style="menulistBorderBottom">
            <template slot="title">
              <i :class="icons[index]" />
              <span>{{ menu.menu }}</span>
            </template>
            <el-menu-item v-for="(child, sort) in menu.child" :key="sort" :index="'menu-' + index + '-' + sort"
